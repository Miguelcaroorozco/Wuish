...
var UsuariosService = function () {
    ...
    var UsuariosService = _classThis = /** @class */ (function () {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, users.map(function (_a) {
                                    var password_hash = _a.password_hash, u = __rest(_a, ["password_hash"]);
                                    return u;
                                })];
                    }
                });
        ...
        UsuariosService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var user, password_hash, sanitized;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            password_hash = user.password_hash, sanitized = __rest(user, ["password_hash"]);
                            return [2 /*return*/, sanitized];
                    }
                });
            });
        };
        UsuariosService_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                var user, password_hash, sanitized;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsuariosService_1.prototype.count = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.usuario.count()];
                });
            });
        };
